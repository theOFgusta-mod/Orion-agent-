export const dict = {
  ...
  "settings.general.row.wallpaper.title": "Papel de parede",
  "settings.general.row.wallpaper.description": "Definir uma imagem de fundo para o aplicativo",
  "settings.general.row.wallpaper.choose": "Escolher",
  "settings.general.row.wallpaper.pickTitle": "Escolha uma imagem de fundo",
