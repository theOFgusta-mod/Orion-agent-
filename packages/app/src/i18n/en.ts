export const dict = {
  ...
  "settings.general.row.wallpaper.title": "Wallpaper",
  "settings.general.row.wallpaper.description": "Set a background image for the app",
  "settings.general.row.wallpaper.choose": "Choose",
  "settings.general.row.wallpaper.pickTitle": "Choose a wallpaper image",
